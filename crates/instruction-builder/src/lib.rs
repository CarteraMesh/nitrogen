...
impl TransactionBuilder {
    pub fn push<T: BorshSerialize>(mut self, builder: InstructionBuilder<T>) -> Self {
        self.instructions.push(builder.instruction());
        self
    }
    ...
    pub fn send<S: Signers + ?Sized>(
        ...
        let result = rpc.simulate_transaction_with_config(&tx, RpcSimulateTransactionConfig {
            sig_verify: true,
        ...
        rpc.send_and_confirm_transaction(&tx).map_err(|e| e.into())
    }
